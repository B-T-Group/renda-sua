      ...
      >
        ...
        >
          <Suspense fallback={<RouteSuspenseFallback />}>
            ...
            {/* Stripe hosted-checkout return route */}
            <Route
              path="/payment/return"
              element={
                <ProtectedRoute>
                  <LazyPages.StripeReturnPage />
                </ProtectedRoute>
              }
            />
            ...
            <Route
              ...
              element={
                <ProtectedRoute>
                  <LazyPages.BusinessAccountsPage />
                </ProtectedRoute>
              }
            />
            <Route
            ...
            <Route
              ...
              element={
                <ProtectedRoute>
                  <LazyPages.BusinessAccountTypePage />
                </ProtectedRoute>
              }
            />
            <Route
            ...
            <Route
              ...
              element={
                <ProtectedRoute>
                  <LazyPages.BusinessIntegrationsPage />
                </ProtectedRoute>
              }
            />
            <Route
