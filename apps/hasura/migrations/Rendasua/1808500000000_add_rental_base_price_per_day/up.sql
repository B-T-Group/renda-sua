-- Dual pricing: hourly + all-day flat rate per calendar day
...
COMMENT ON COLUMN public.rental_location_listings.base_price_per_day IS
  'Flat price for one full-day (all-day) rental window; hourly uses base_price_per_hour';
