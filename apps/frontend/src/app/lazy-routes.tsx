...
/** Route-level code splitting; prefetch hot paths from home. */
...
export const AdminItemsModerationPage = lazy(() =>
  import('../components/pages/AdminItemsModerationPage')
);
export const AdminContentReportsPage = lazy(() =>
  import('../components/pages/AdminContentReportsPage')
);
...
export const BusinessItemAiProposalPage = lazy(() =>
  import('../components/pages/BusinessItemAiProposalPage')
);
...
export const ConnectOnboardingReturnPage = lazy(() =>
  import('../components/pages/ConnectOnboardingReturnPage')
);
...
export const ItemFormPage = lazy(() =>
  import('../components/pages/ItemFormPage')
);
export const OtpAuthPage = lazy(() =>
  import('../components/pages/OtpAuthPage')
);
...
export const AgentDashboard = lazy(() =>
  import('../components/pages/AgentDashboard')
);
export const FAQ = lazy(() => import('../components/pages/FAQ'));
export const ItemDetailPage = lazy(
  () =>
    import(
      /* webpackPrefetch: true */
      '../components/pages/ItemDetailPage'
    )
);
...
export const RentalsPage = lazy(() =>
  import('../components/pages/RentalsPage')
);
...
export const AgentLandingPage = lazy(() =>
  import('../components/pages/AgentLandingPage')
);
...
export const PlaceOrderPage = lazy(() =>
