...
} from './rental-listing-ai-review.prompt';
import {
  AiReviewModelResult,
  ListingForAiReview,
  ListingImageForReview,
  PROMPT_VERSION,
...
export class RentalListingAiReviewModelService {
  ...
  private async buildMultimodalContent(listing: ListingForAiReview) {
  ...
  private async toImageUrl(img: ListingImageForReview): Promise<string | null> {
