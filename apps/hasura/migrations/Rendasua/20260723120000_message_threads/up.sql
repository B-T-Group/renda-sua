...
CREATE INDEX IF NOT EXISTS idx_message_threads_created_by ON public.message_threads(created_by_user_id);
CREATE INDEX IF NOT EXISTS idx_message_threads_recipient ON public.message_threads(recipient_user_id);
...
CREATE INDEX IF NOT EXISTS idx_thread_messages_sender ON public.thread_messages(sender_user_id);
