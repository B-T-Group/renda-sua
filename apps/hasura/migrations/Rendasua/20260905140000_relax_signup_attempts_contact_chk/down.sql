-- Restore original constraint (requires all rows to have contact per channel).
-- Rolling this back would fail if any completed/expired/failed rows have null contacts.
