...
export interface CatalogFeedGoesWithBagStopProps {
...
/**
 * "Goes with your bag" mid-feed stop.
 * Shows complementary items based on what's in the cart.
 */
export const CatalogFeedGoesWithBagStop = memo(function CatalogFeedGoesWithBagStop({
  items,
  onItemPress,
}: CatalogFeedGoesWithBagStopProps) {
      ...
      <View style={[styles.headerRow, { paddingHorizontal: spacing.md, paddingTop: spacing.md }]}>
        <View style={styles.titleRow}>
          ...
          <View style={{ flex: 1, minWidth: 0 }}>
            ...
            >
              {t('catalog.goesWithBag.title', 'Goes with your bag')}
            </Text>
            <Text
              variant="bodySmall"
              style={{ color: colors.text.secondary, marginTop: 2 }}
            >
              {t('catalog.goesWithBag.subtitle', 'Complete your order')}
            </Text>
          </View>
        </View>
      </View>
